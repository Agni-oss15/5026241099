...
<body>
    <div class="container">
        ...
        <div class="MainSection">
            <div>
                <p><b>Book a Session</b></p>
            </div>


            <div>
                <a href="https://bit.ly/BookPhotoEvent" target="_blank"
                    class="btn btn-outline-warning btn-block rounded-pill linkFont py-3">
                    Cosplay Event Photoshoot
                </a>
                <a href="https://bit.ly/BookPhotoEvent" target="_blank"
                    class="btn btn-outline-warning btn-block rounded-pill linkFont py-3">
                    Cosplay Event Photoshoot
            ...
            <div>
                <a href="https://bit.ly/Book_Graduation" target="_blank"
                    class="btn btn-outline-warning btn-block rounded-pill linkFont py-3"> Link Button
                    Graduation Photoshoot
                </a>
                <p></p>
            </div>

            <p><b>About My Works</b></p>

            <div>
                <a href="https://bit.ly/COS_PL_AGNI_2025" target="_blank"
                    class="btn btn-outline-warning btn-block rounded-pill linkFont py-3">
                    Cosplay Pricelist Agni.Graph
                </a>
                <p></p>
            </div>

            <div>
                <a href="https://bit.ly/Feedback-agni"
                    class="btn btn-outline-warning btn-block rounded-pill linkFont py-3">
                    Rating Agni.Graph
                </a>
                <p></p>
            ...
            <div>
                <a href="https://bit.ly/Portfolio_2025_AgniGraph" target="_blank"
                    class="btn btn-outline-warning btn-block rounded-pill linkFont py-3">
                    Portofolio Agni.Graph
                </a>
                <p></p>
            </div>

            <div>
                <a href="#" onclick="showme()" class="btn btn-info btn-block rounded-pill linkFont py-3">
                    SHOW ME
                </a>
                <p></p>
            </div>
            ...
            <div>
                <a onclick="changeText()" class="btn btn-info btn-block rounded-pill linkFont py-3">
                    CHANGE TEXT
                </a>
                <p></p>
            </div>
            ...
            <div>
                <a onclick="changeStyle()" class="btn btn-info btn-block rounded-pill linkFont py-3">
                    CHANGE STYLE
                </a>
                <p></p>
            </div>
